...
namespace fixbug {
class GetFriendListsQuest;
class GetFriendListsQuestDefaultTypeInternal;
extern GetFriendListsQuestDefaultTypeInternal _GetFriendListsQuest_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendListsQuest* Arena::CreateMaybeMessage<::fixbug::GetFriendListsQuest>(Arena*);
...
class GetFriendListsQuest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsQuest) */ {
 public:
  GetFriendListsQuest();
  virtual ~GetFriendListsQuest();

  GetFriendListsQuest(const GetFriendListsQuest& from);
  GetFriendListsQuest(GetFriendListsQuest&& from) noexcept
    : GetFriendListsQuest() {
    *this = ::std::move(from);
  }

  inline GetFriendListsQuest& operator=(const GetFriendListsQuest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsQuest& operator=(GetFriendListsQuest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsQuest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsQuest* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsQuest*>(
               &_GetFriendListsQuest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(GetFriendListsQuest& a, GetFriendListsQuest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsQuest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListsQuest* New() const final {
    return CreateMaybeMessage<GetFriendListsQuest>(nullptr);
  }

  GetFriendListsQuest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsQuest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsQuest& from);
  void MergeFrom(const GetFriendListsQuest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsQuest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsQuest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsQuest)
 private:
  class _Internal;
...
// uint32 userid = 1;
inline void GetFriendListsQuest::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsQuest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsQuest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsQuest.userid)
  return _internal_userid();
}
inline void GetFriendListsQuest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriendListsQuest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsQuest.userid)
}
